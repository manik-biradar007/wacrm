/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c741e392df95553cc8b547a1e4a0c37)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ORDERS_PG_HOST: string;
	ORDERS_PG_PORT: string;
	ORDERS_PG_DBNAME: string;
	ORDERS_PG_USER: string;
	ORDERS_PG_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORDERS_PG_HOST" | "ORDERS_PG_PORT" | "ORDERS_PG_DBNAME" | "ORDERS_PG_USER" | "ORDERS_PG_PASSWORD" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "ENCRYPTION_KEY" | "META_APP_SECRET" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_APP_LOCALE">> {}
}
